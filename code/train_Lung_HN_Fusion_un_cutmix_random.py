...
from utils.cutmix_util import random_keep_mask, pred_mask_back
...
### mask
parser.add_argument('--patch_scale', type=float, default=4)
...
if __name__ == "__main__":
    ...
    for epoch_num in tqdm(range(max_epoch), ncols=70):
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            mask = random_keep_mask(volume_batch[:labeled_bs], keep_mask_ratio=0.5, patch_scale=args.patch_scale)
